        ...
        <head>
            ...
            <style>
                * { margin: 0; padding: 0; box-sizing: border-box; }
                body { font-family: 'Arial', sans-serif; text-align: center; padding: 50px 20px; background: #0a0a0f; color: white; min-height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center; }
                ...
                .search-container input[type="text"] { padding: 16px 20px; width: 100%; border-radius: 10px; border: 2px solid #1a1a2e; background: #1a1a2e; color: white; font-size: 16px; outline: none; transition: border-color 0.3s ease; }
                .search-container input[type="text"]:focus { border-color: #00d4ff; }
                .search-container button { margin-top: 15px; }
                .btn { background: #00d4ff; color: #0a0a0f; padding: 15px 40px; border: none; border-radius: 10px; font-size: 18px; font-weight: 700; cursor: pointer; text-decoration: none; display: inline-block; margin: 8px; transition: transform 0.2s ease, background 0.2s ease; }
                .btn:hover { background: #00b8e6; transform: scale(1.03); }
                .btn-gold { background: #FFD700; color: #0a0a0f; padding: 15px 40px; border: none; border-radius: 10px; font-size: 18px; font-weight: 700; cursor: pointer; text-decoration: none; display: inline-block; margin: 8px; transition: transform 0.2s ease, background 0.2s ease; }
                .btn-gold:hover { background: #e6c200; transform: scale(1.03); }
                .btn-dark { background: #333; color: white; padding: 15px 40px; border: none; border-radius: 10px; font-size: 18px; font-weight: 700; cursor: pointer; text-decoration: none; display: inline-block; margin: 8px; transition: transform 0.2s ease, background 0.2s ease; }
                ...
                .feature { background: #1a1a2e; padding: 25px 20px; border-radius: 14px; width: 200px; border: 1px solid #2a2a4a; transition: transform 0.2s ease, border-color 0.2s ease; }
                ...
                @media (max-width: 700px) {
                    ...
                    .btn, .btn-gold, .btn-dark { padding: 12px 25px; font-size: 15px; display: block; margin: 10px auto; width: 80%; max-width: 280px; }
                }
        ...
        <body>
            ...
            <script>
                function search() {
                    ...
                    if (query.trim() !== '') {
                        window.location.href = 'https://moteur-de-recherche-it-mzztfdhtggde7omb8uhzek.streamlit.app/?q=' + encodeURIComponent(query);
                    } else {
